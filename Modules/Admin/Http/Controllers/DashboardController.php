...
class DashboardController extends AdminController {
    ...
    public function index() {
        $data_msg = [];
        $data_msg['total_Product'] = Product::where('status','=', '1')->count();
        $data_msg['total_addon'] = Addon::where('status','=', '1')->count();
        $data_msg['total_addon_categories'] = AddonCategory::where('status','=', '1')->count();
