    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-addon-cat-store')}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-body">
                        ...
                        <div class="form-group {{ $errors->has('addons') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                  ...
                                  <ul class="items">
                                    ...
                                    <li><label><input type="checkbox" name="addons[]" class="check" value="{{ $addon->id }}" {{ (old('addons')!="") ? ($addon->name==old('addons'))?'checked':'' : ''}} /> {{ $addon->name }}</label> </li>
                                    @endforeach
