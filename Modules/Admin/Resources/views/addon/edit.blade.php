...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route('admin-addon-index')}}">Addon</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Update Addon of {{$data->name}}</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-addon-update',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{Route('admin-addon-index')}}" class="btn btn-primary">Cancel</a>
