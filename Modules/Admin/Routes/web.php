...
Route::prefix('admin')->group(function() {
    ...
    Route::middleware(['admin_not_logged_in'])->group(function () {
        ...
        Route::get('/', ['uses' => 'AuthController@get_login', 'as' => '/']);
    ...
    Route::middleware(['admin_logged_in'])->group(function () {
        ...
        Route::get('/addon-category/datatables', 'AddonCategoryController@datatables')->name('admin-addon-cat-datatables'); //JSON REQUEST
        Route::get('/addon-category', 'AddonCategoryController@index')->name('admin-addon-cat-index');
        Route::get('/addon-category/create', 'AddonCategoryController@create')->name('admin-addon-cat-create');
        Route::post('/addon-category/create', 'AddonCategoryController@store')->name('admin-addon-cat-store');
        Route::get('/addon-category/edit/{id}', 'AddonCategoryController@edit')->name('admin-addon-cat-edit');
        Route::post('/addon-category/edit/{id}', 'AddonCategoryController@update')->name('admin-addon-cat-update');
        Route::post('/addon-category/delete/{id}', 'AddonCategoryController@destroy')->name('admin-addon-cat-delete');
        ...
        Route::get('/addon/datatables', 'AddonController@datatables')->name('admin-addon-datatables'); //JSON REQUEST
        Route::get('/addon', 'AddonController@index')->name('admin-addon-index');
        Route::get('/addon/create', 'AddonController@create')->name('admin-addon-create');
        Route::post('/addon/create', 'AddonController@store')->name('admin-addon-store');
        Route::get('/addon/edit/{id}', 'AddonController@edit')->name('admin-addon-edit');
        Route::post('/addon/edit/{id}', 'AddonController@update')->name('admin-addon-update');
        Route::post('/addon/delete/{id}', 'AddonController@destroy')->name('admin-addon-delete');
